...
class Config:
    ...
    CLASS_INFO = {
        ...
        'dandelion': {'emoji': '🌻', 'description': 'Bright yellow composite flower'},
        'rose': {'emoji': '🌹', 'description': 'Classic layered petals, often red or pink'},
...
# Enhanced data loading with advanced augmentation
